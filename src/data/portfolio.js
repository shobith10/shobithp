export const portfolioData = {
    ...
    subtitle: "Cross-Platform Developer | 4+ Years Experience",
    email: "shobithknb99@gmail.com",
    phone: "+91 9526772932",
    location: "India",
    bio: "I'm a passionate Flutter developer with over 4 years of experience building robust cross-platform mobile applications. Specialized in creating exceptional digital experiences for healthcare, e-commerce, and enterprise solutions.",
    ...
    projects: [
        {
            title: "DoctorG",
            description: "Healthcare application for doctor-patient consultation and appointment management with telemedicine features",
        ...
        {
            title: "MyGrapes",
            description: "Enterprise application for business operations, inventory management, and resource planning",
            technologies: ["Flutter", "REST API", "SQLite", "BLoC"],
            icon: "📊",
            links: {
                demo: "#",
                github: "#"
        ...
        },
        {
            ...
            description: "Full-featured e-commerce application with product catalog, cart, checkout, and payment integration",
            technologies: ["Flutter", "Firebase", "Stripe API", "GetX"],
            icon: "🛍️",
            links: {
                demo: "#",
                github: "#"
    ...
    achievements: [
        ...
        },
        {
            ...
            description: "Built solutions for healthcare, e-commerce, ERP, and business management domains",
            icon: "🎯"
        },
        {
            title: "Team Lead Experience",
            description: "Mentored junior developers and contributed to team technical decisions",
            icon: "👥"
        },
        {
            title: "Performance Optimization",
            description: "Optimized apps resulting in 40% faster load times and improved UX",
            icon: "⚡"
        }
    ],
